...
<Highlight block>
    ...
    the <ClaudeCommand archived name="plugins" external /> command.
</Highlight>
...
<GithubLink url="https://github.com/mifkata/blog/tree/main/public/archive/commands">
...
<GithubLink url="https://github.com/mifkata/blog/blob/main/public/archive/specs/components/post/GithubLink.md">
...
I'd restart my **Claude Code** to load the new <ClaudeCommand archived name="commit-staged" />. Here's the actual
command from the blog's repository:

<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/commit-staged.md"
/>
...
<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/spec-create.md"
/>

### /spec-update

I use this to keep the spec language compact and optimal, but sometimes I'd go
and update the spec manually, then call <ClaudeCommand archived name="spec-apply" /> or <ClaudeCommand archived name="spec-verify" />.

<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/spec-update.md"
/>
...
<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/spec-refine.md"
/>

### /spec-apply

I call this after a spec is ready to implement. Sometimes when I have modified both
**specs** and **code**, I'd run <ClaudeCommand archived name="spec-verify" /> instead.

<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/spec-apply.md"
/>
...
<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/spec-verify.md"
/>
...
<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/spec-refactor.md"
/>

### /spec-compact

This command is used by others such as <ClaudeCommand archived name="spec-create" />, but also is very nifty,
...
<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/spec-compact.md"
/>
...
<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/test-create.md"
/>
...
Uses <ClaudeCommand archived name="commit-staged" /> to generate the message, asks for confirmation and commits. Requires
...
<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/post-create.md"
/>

### /tags-update

The landing pages for tags, such as the [ai tags page](https://mifkata.com/tags/ai/) have custom title and description and I save them in [src/data/tags.json](https://github.com/mifkata/blog/blob/main/src/data/tags.json) inside my repository. Because I'll add new tags and I'm either too lazy or forget to update the list, I simply run <ClaudeCommand archived name="tags-update" /> and **Claude** does the job for me.
...
<GithubLink
  expanded
  url="https://github.com/mifkata/blog/blob/main/public/archive/commands/tags-update.md"
/>
