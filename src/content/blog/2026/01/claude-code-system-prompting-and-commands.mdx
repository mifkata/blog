...
- **CLAUDE.md** - this is the primary instruction set that a **Claude agent instance**
  would load when started and after <ClaudeCommand name="compact" external /> completes. This is where you want to put as much nifty
...
about creating a new <ClaudeCommand name="commit-message" /> slash command:
...
I'd restart my **Claude Code** to load the new <ClaudeCommand name="commit-message" />. Here's the actual
...
Uses <ClaudeCommand name="commit-message" /> to generate the message, asks for confirmation and commits. Requires
...
update the list, I simply run <ClaudeCommand name="tags-update" /> and **Claude** does the job for me.
