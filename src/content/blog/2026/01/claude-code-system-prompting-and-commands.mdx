...
<WrapText>
  ```sh Create a new command /commit-message that goes and checks all staged
  diffs and generates a commit message using Conventional Commits. Keep the
  messages tight, omit references to author/generator, compact the command to be
  AI-friendly with minimal token usage ```
</WrapText>
